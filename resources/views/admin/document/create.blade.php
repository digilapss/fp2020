		...
		<div class="col-md-12">
		    <div class="card">
		        ...
		        <div class="card-body">
		        	...
		        	<form class="form form-horizontal" action="{{ route('admin.document.post.create') }}" method="post" enctype="multipart/form-data">
					    ...
					    <div class=" {{ $errors->has('description') ? 'form-group has-error' : 'form-group'}} ">
					        <div class="col-md-2">
					          ...
					          <p class="control-label-help">( short detail of document description , 150 max words )</p>
					        </div>
					        <div class="col-md-10">
