		        ...
		        <div class="card-body">
		        	...
		        	<form class="form form-horizontal" action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
					    ...
					    <div class=" {{ $errors->has('body') ? 'form-group has-error' : 'form-group'}} ">
					        ...
					        <div class="col-md-10">
					          <textarea class="form-control" id="summernote" data-plugin="summernote" name="body" rows="10">{{ Request::old('body') ? Request::old('body') : isset($profile) ? $profile->body : ''}}</textarea>
					        </div>
					    </div>
