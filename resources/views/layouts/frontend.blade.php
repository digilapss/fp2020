...
<html>
<head>
<title>The Asteet bootstrap Website Template | Home :: w3layouts</title>
<link href="{{ HTML::style('css/bootstrap.css'); }}" rel='stylesheet' type='text/css' />
<link href="{{ HTML::style('css/style.css'); }}" rel='stylesheet' type='text/css' />
<meta name="viewport" content="width=device-width, initial-scale=1">	
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<script src="{{ HTML::script('js/jquery-1.11.0.min.js'); }}"></script>
<link rel="stylesheet" href="{{ HTML::style('css/flexslider.css'); }}" type="text/css" media="screen" />
<link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:200,300,400,600,700,900,200italic,300italic,400italic,600italic,700italic,900italic' rel='stylesheet' type='text/css'>
<script src="{{ HTML::script('js/modernizr.js'); }}"></script>
<!--Start-smoth-scrolling-->
		<script type="text/javascript" src="{{ HTML::script('js/move-top.js'); }}"></script>
		<script type="text/javascript" src="{{ HTML::script('js/easing.js'); }}"></script>	
...
<!--end-smoth-scrolling-->
<!--animated-css-->
		<link href="{{ HTML::style('css/animate.css'); }}" rel="stylesheet" type="text/css" media="all">
		<script src="{{ HTML::script('js/wow.min.js'); }}"></script>
		<script>
		 new WOW().init();
		</script>
<!--animated-css-->
...
<body>
      <div class="mother-grid" id="home">
                               <div class="container">
                                                      <div class="header clock wow bounceIn">
                                                                          <h1><a href="index.html">ASTEET</a></h1>
                                                                          <div class="nav-top">
                                                                                         <span class="menu"><img src="{{ URL::asset('images/menu-icon.png'); }}" alt=""></span>
                                                                          <ul class="navgation">
  ...
  <script>window.jQuery || document.write('<script src="{{ HTML::script("js/libs/jquery-1.7.min.js"); }}">\x3C/script>')</script>
  <!--FlexSlider-->
  <script defer src="{{ HTML::script('js/jquery.flexslider.js'); }}"></script>
  <script type="text/javascript">
    $(function(){
...
<!--Responsive-tabs-Starts-Here-->
	<div class="responsive-tabs" id="project">
		<div class="container">
			...
			<ul class="tabs-menu">
				<li><a href="#tab1"><img src="images/f.png" alt="">SED EGEST ASTEET</a></li>
				<li><a href="#tab2"><img src="images/d.png" alt="">MORBI INTERDUM</a></li>
				<li><a href="#tab3"><img src="images/u.png" alt="">MORBI INTERDUM</a></li>
			</ul>
			<div class="clearfix"> </div>
			<div class="tab-grids">
				...
				<div id="tab3" class="tab-grid">
					<div class="col-md-6 line1">
						<img src="images/boy7.png" alt="">
						<p>Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis Gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis lorem ipsum dolor.</p>
					    </div>
					 <div class="col-md-6 line2">   
				                <img src="images/boy9.png" alt="">
						<p>Lorem egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis Gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper at felis lorem ipsum dolor.</p>
					</div>
					 <div class="clearfix"> </div>
				</div>
		...
		<!--Script-->
		<script src="{{ HTML::script('js/jquery-1.11.0.min.js'); }}"></script>
		<script src="{{ HTML::script('js/myscript.js'); }}"> </script>
`		<!--Script-->
	</div>
